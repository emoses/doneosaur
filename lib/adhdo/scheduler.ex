defmodule Adhdo.Scheduler do
  ...
  @impl true
  def init(:ok) do
    Logger.info("Starting Adhdo.Scheduler")
  ...
  defp format_schedule(schedule) do
    day_name = Adhdo.Lists.Schedule.day_name(schedule.day_of_week)
  ...
  defp get_timezone do
    Application.get_env(:adhdo, :timezone, "Etc/UTC")
  end
end

defmodule Doneosaur.Lists do
  ...
  alias Doneosaur.Lists.{TaskList, Task, Image, Schedule}
  ...
  def get_image_url(%Image{uuid: uuid, type: type}) do
    base_path = Application.get_env(:doneosaur, :image_path, "/images/tasks")
    "#{base_path}/#{uuid}.#{type}"
  end
